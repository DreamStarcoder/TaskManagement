...
public class Config {
  ...
  //  @RequiresApi(api = Build.VERSION_CODES.O )
    ...
    public static void createNotificationChannels(Context context){
        ...
        notificationChannelGroups.add(new NotificationChannelGroup("notify","notify"));
        ...
        flash_message_channel.setGroup("notify");
        ...
        comments_channel.setGroup("notify");
        ...
        NotificationChannel _other_channel=new NotificationChannel("_other_channel","Other Notifications",NotificationManager.IMPORTANCE_LOW);
        _other_channel.enableLights(true);
        _other_channel.enableVibration(true);
        _other_channel.setGroup("notify");
        _other_channel.setSound(Uri.parse("android.resource://"+context.getPackageName()+"/"+ R.raw.hify_sound), null);
        ...
        notificationChannels.add(_other_channel);
